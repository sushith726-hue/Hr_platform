...
## Corpus Check
- 45 files · ~59,977 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 373 nodes · 644 edges · 55 communities detected
- Extraction: 54% EXTRACTED · 46% INFERRED · 0% AMBIGUOUS · INFERRED: 299 edges (avg confidence: 0.52)
- Token cost: 66,746 input · 28,691 output
...
### Community 0 - "Frontend Utility Functions"
Cohesion: 0.06
...
### Community 1 - "Python Job Management"
Cohesion: 0.05
...
### Community 5 - "Database Migration Scripts"
Cohesion: 0.08
...
### Community 6 - "Documentation and Compliance"
Cohesion: 0.14
...
### Community 7 - "Testing and Session Management"
Cohesion: 0.17
...
### Community 8 - "Project Phases Overview"
Cohesion: 0.2
...
### Community 9 - "Resume Review Workflow"
Cohesion: 0.22
...
### Community 10 - "Interview Scoring Tools"
Cohesion: 0.29
...
### Community 13 - "Candidate Scoring Framework"
Cohesion: 0.4
...
### Community 31 - "Resume Upload Issues"
Cohesion: 1.0
...
### Community 32 - "Resume Upload Modality"
Cohesion: 1.0
Nodes (2): Modality for Resume Uploads, Resume Upload Zone Redesign

### Community 33 - "Candidate Card Designs"
Cohesion: 1.0
Nodes (2): Compact Candidate Card Representation, Empty State Card Redesign

### Community 34 - "Verification Criteria"
Cohesion: 1.0
Nodes (2): Behavioral Criteria, Resume Verification Criteria

### Community 35 - "Candidate Interview Systems"
Cohesion: 1.0
Nodes (2): Candidate Portal, LiveKit Cloud WebRTC Server

### Community 36 - "Cloud Storage Solutions"
Cohesion: 1.0
Nodes (2): Candidate Interview Process, MinIO/S3 Cloud Storage

### Community 37 - "Evaluation Summaries"
Cohesion: 1.0
Nodes (1): Candidate Evaluation Summary

### Community 38 - "Behavioral Scoring Model"
Cohesion: 1.0
Nodes (1): BB5 Behavioral Scorer

### Community 39 - "Initialization Scripts"
Cohesion: 1.0
Nodes (0): 

### Community 40 - "Template Engine"
Cohesion: 1.0
Nodes (1): Jinja2

### Community 41 - "UI Component Issues"
Cohesion: 1.0
Nodes (1): Job tree not accordion dropdown

### Community 42 - "CSS Compatibility Warnings"
Cohesion: 1.0
Nodes (1): CSS background-clip compatibility warning

### Community 43 - "Bulk Processing Visibility"
Cohesion: 1.0
Nodes (1): Resume upload bulk processing visibility

### Community 44 - "Manual Review Processes"
Cohesion: 1.0
Nodes (1): Manual review flow for parsed-failed candidates

### Community 45 - "Button Styling"
Cohesion: 1.0
Nodes (1): UI Button Styling

### Community 46 - "Resizable Layouts"
Cohesion: 1.0
Nodes (1): 3-Panel Resizable Layout

### Community 47 - "Theme Palette"
Cohesion: 1.0
Nodes (1): Light Theme Palette

### Community 48 - "Button Refactoring"
Cohesion: 1.0
Nodes (1): Action Button Refactor

### Community 49 - "Rubric Generation Tool"
Cohesion: 1.0
Nodes (1): RVC to Rubric Generator

### Community 50 - "Data Extraction Tools"
Cohesion: 1.0
Nodes (1): Resume Data Extractor

### Community 51 - "Candidate Management"
Cohesion: 1.0
Nodes (1): Candidate

### Community 52 - "Job Management"
Cohesion: 1.0
Nodes (1): Job

### Community 53 - "Interview Management"
Cohesion: 1.0
Nodes (1): Interview

### Community 54 - "Note Management"
Cohesion: 1.0
Nodes (1): Note
...
- **Thin community `Platform Verification Scripts`** (2 nodes): `verify.py`, `verify_platform()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `S3 Connection Tests`** (2 nodes): `test_s3.py`, `verify_s3_connection()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Pipeline Logging`** (2 nodes): `pipeline_logger.py`, `log_pipeline_event()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Documentation Resources`** (2 nodes): `Bhagavad Geetha Documentation`, `Onboarding Documentation`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Architecture Specifications`** (2 nodes): `Architecture Specification`, `TalentStream Architecture Master`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `UI Redesign Iterations`** (2 nodes): `Iteration 6 — Empty State Card Redesign`, `Iteration 7 — Resume Upload Zone Redesign`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `UI Button Issues`** (2 nodes): `Buttons look like 'stool rectangles'`, `Shortlist button not working`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Dashboard Status Issues`** (2 nodes): `Dashboard status inconsistencies for failed / unable_to_process states`, `Lack of pagination for high candidate volume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Resume Upload Modality`** (2 nodes): `Modality for Resume Uploads`, `Resume Upload Zone Redesign`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Candidate Card Designs`** (2 nodes): `Compact Candidate Card Representation`, `Empty State Card Redesign`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Verification Criteria`** (2 nodes): `Behavioral Criteria`, `Resume Verification Criteria`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Candidate Interview Systems`** (2 nodes): `Candidate Portal`, `LiveKit Cloud WebRTC Server`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Cloud Storage Solutions`** (2 nodes): `Candidate Interview Process`, `MinIO/S3 Cloud Storage`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Evaluation Summaries`** (1 nodes): `Candidate Evaluation Summary`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Behavioral Scoring Model`** (1 nodes): `BB5 Behavioral Scorer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Initialization Scripts`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Template Engine`** (1 nodes): `Jinja2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `UI Component Issues`** (1 nodes): `Job tree not accordion dropdown`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `CSS Compatibility Warnings`** (1 nodes): `CSS background-clip compatibility warning`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Bulk Processing Visibility`** (1 nodes): `Resume upload bulk processing visibility`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Manual Review Processes`** (1 nodes): `Manual review flow for parsed-failed candidates`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Button Styling`** (1 nodes): `UI Button Styling`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Resizable Layouts`** (1 nodes): `3-Panel Resizable Layout`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Theme Palette`** (1 nodes): `Light Theme Palette`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Button Refactoring`** (1 nodes): `Action Button Refactor`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Rubric Generation Tool`** (1 nodes): `RVC to Rubric Generator`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Data Extraction Tools`** (1 nodes): `Resume Data Extractor`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Candidate Management`** (1 nodes): `Candidate`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Job Management`** (1 nodes): `Job`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Interview Management`** (1 nodes): `Interview`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Note Management`** (1 nodes): `Note`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `SQLAlchemy` connect `Database Migration Scripts` to `Data Models and Requests`, `Backend Frameworks and Tools`, `Testing and Session Management`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `Redis` connect `Backend Frameworks and Tools` to `Python Job Management`, `Testing and Session Management`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `Celery` connect `Backend Frameworks and Tools` to `Database Migration Scripts`?**
